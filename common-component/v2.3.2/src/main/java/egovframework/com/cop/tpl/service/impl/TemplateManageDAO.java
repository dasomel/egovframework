 ...
 *  2019.05.21   신용호          KISA 취약점 조치 및 보완
 *
 * </pre>
 */
...
public class TemplateManageDAO extends EgovComAbstractDAO {
    ...
    public List<TemplateInfVO> selectTemplateWhiteList() throws Exception {
    	return (List<TemplateInfVO>) list("TemplateManageDAO.selectTemplateWhiteList", null);
    }
	...
	return (Integer)selectByPk("TemplateManageDAO.selectTemplateInfsCnt", tmplatInfVO);
    }
