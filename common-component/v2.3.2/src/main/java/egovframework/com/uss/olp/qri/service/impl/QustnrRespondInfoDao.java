...
public class QustnrRespondInfoDao extends EgovComAbstractDAO {
	...
	public Map<?, ?> selectQustnrRespondInfoManageEmplyrinfo(Map<?, ?> map) throws Exception{
		return (Map<?, ?>)selectByPk("QustnrRespondInfo.selectQustnrRespondInfoManageEmplyrinfo", map);
	}
	...
	public int selectQustnrRespondInfoManageListCnt(ComDefaultVO searchVO) throws Exception{
		return (Integer)selectByPk("QustnrRespondInfo.selectQustnrRespondInfoManageCnt", searchVO);
	}
	...
	public int selectQustnrRespondInfoListCnt(ComDefaultVO searchVO) throws Exception{
		return (Integer)selectByPk("QustnrRespondInfo.selectQustnrRespondInfoCnt", searchVO);
	}
	...
	public List<?> selectQustnrTmplatWhiteList() throws Exception{
		return list("QustnrRespondInfo.selectQustnrTmplatWhiteList", null);
	}
