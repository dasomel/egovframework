...
public class PopupManageDAO extends EgovComAbstractDAO {
	...
	public PopupManageVO selectPopup(PopupManageVO popupManageVO) throws Exception {
	    return (PopupManageVO)selectByPk("PopupManage.selectPopupManageDetail", popupManageVO);
	}
	...
	public List<?> selectPopupWhiteList() throws Exception {
	    return list("PopupManage.selectPopupWhiteList", null);
	}
	...
	public List<?> selectPopupList(PopupManageVO popupManageVO) throws Exception {
        ...
        return (Integer)selectByPk("PopupManage.selectPopupManageCnt", popupManageVO);
        }
