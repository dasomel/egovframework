...
public class EgovServerResrceMntrngScheduling extends EgovAbstractServiceImpl {
	...
	public void init(ServerResrceMntrngVO serverResrceMntrngVO) throws Exception {
		...
		ServerResrceMntrng serverResrceMntrng = new ServerResrceMntrng();
		...
		try {
			JMXServiceURL address = new JMXServiceURL("service:jmx:rmi://" + serverEqpmnIp + ":9999/jndi/rmi://" + serverEqpmnIp + ":9999/server");
		...
		} catch (MalformedURLException e) {//KISA 보안약점 조치 (2018-10-29, 윤창원)
			serverResrceMntrng.setSvcSttus("02");

			ByteArrayOutputStream out = new ByteArrayOutputStream();

			LOGGER.debug("JMX error [MalformedURLException]", e);
